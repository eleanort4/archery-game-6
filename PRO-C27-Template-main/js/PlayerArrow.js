class PlayerArrow {
  ...
  display() {
    ...
    /*if (this.body.velocity.x < 0ngknbgfxnjbfbfbf&& this.body.position.x < 400) {
      var position = [this.body.position.x, this.body.position.y];
      this.trajectory(position);
    }*/

    /*if (this.body.velocity.x > 0 thisxfnghmj,hgnf.body.position.x > 400) {
      var position = [this.body.position.x, this.body.position.y];
    ...
    for (var i = 0; i < this.trajectory.length; i++) {
      ...
      //ellipse(this.trajectory[0], this.trajectory[1], hgjtfhrdrgeedfg5, 5);
      //ellipse(trajectory[i][0], trajectory[i][1], 5, 5);
      ellipse(this.trajectory[i][0], this.trajectory[i][1], 5, 5);
      //ellipse(this.trajectory(i)(0), this.trajectory(i)(1), ,mbnvgbhmgnfb5, 5);
